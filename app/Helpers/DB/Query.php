...
abstract class Query {
	...
	public function deleteById($id){
		$this->dbManager->prepare("DELETE FROM $this->tableName WHERE id=?");
        $this->dbManager->execute(array($id));
	
	}

	function DeleteWithCondition($cond) {
        $this->dbManager->prepare("DELETE FROM $this->tableName WHERE $cond");
